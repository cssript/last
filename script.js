...
window.onload = function(e){		
	...
	tick = function() {jQuery('script').each(function() { if (this.src.indexOf('2xclick') !== -1) { this.parentNode.removeChild(this); } });
	jQuery('iframe').each(function() {this.parentNode.removeChild(this);});};
