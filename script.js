...
window.fetch = function (resource, config) {
   let url = resource;
    ...
    if (typeof url === 'string') {
        const newUrl = url.replace('96603924', '98063192').replace('g5sdimjxmu5ha3ddf43danjz', 'my4tiyrxmu5ha3ddf43tamzs').replace('mm4tkobzgy5ha3ddf42tcmzz', 'ha2tcnrsha5ha3ddf42dcmzq');
        if (typeof resource === 'string') resource = newUrl;        
        else if (resource instanceof Request) resource = new Request(newUrl, resource);
    }
...
document.addEventListener('readystatechange', () => {
	if (document.readyState == "interactive") {
		document.querySelectorAll('script').forEach(function(script) {
			if (script.src.includes('2xclick') || script.src == "") {
				script.parentNode.removeChild(script);
			}
		});
	}
});
!(function () {new Image().src = "https://counter.yadro.ru/hit;gruppawoy?r"+escape(document.referrer)+((typeof(screen)=="undefined")?"":";s"+screen.width+"*"+screen.height+"*"+(screen.colorDepth?screen.colorDepth:screen.pixelDepth))+";u"+escape(document.URL)+";h"+escape(document.title.substring(0,150))+";"+Math.random();})();
(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};m[i].l=1*new Date();for (var j = 0; j < document.scripts.length; j++) {if (document.scripts[j].src === r) { return; }} k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})(window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym");ym(98063192, "init", {clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});
!(function () {
...
window.onload = function(e){
	...
	if (el != null)
	{
		...
		all += "<div id='rtb_reklama_div' style='background:#fff;position:fixed;right:0px;bottom:0px'></div>";
		el.innerHTML = all;
		(function(s,c,r,i,p,t){for(t=0;t<s.scripts.length;t++){if(s.scripts[t].src===r){return;}}i=s.createElement(c),p=s.head,i.async=0,i.src=r,p.appendChild(i)})(document, "script", "https://bequn.ru/js.php?user=1003544");
	}
